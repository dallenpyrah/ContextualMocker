...
public class ContextualMockBuilder {
    ...
    public static class OngoingStubbingInBuilder<T, R> {
        ...
        private final ContextualMocker.OngoingContextualStubbing<T, R> stubbing;

        OngoingStubbingInBuilder(ContextualMockBuilder builder, ContextualMocker.OngoingContextualStubbing<T, R> stubbing) {
     ...
     */
    public <T> ContextualMockBuilder verify(T mock, ContextualMocker.ContextualVerificationMode mode, Supplier<?> methodCall) {
