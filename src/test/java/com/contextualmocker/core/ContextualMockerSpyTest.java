...
class ContextualMockerSpyTest {
    ...
    void spyWithArgumentMatchers() {
        ...
        try (ContextScope scope = scopedContext(testContext)) {
            scope.when(spy, () -> spy.processData(com.contextualmocker.matchers.ArgumentMatchers.startsWith("special")))
            ...
            scope.verify(spy, times(1), () -> spy.processData(com.contextualmocker.matchers.ArgumentMatchers.startsWith("special")));
