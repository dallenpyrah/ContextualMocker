...
import io.github.dallenpyrah.contextualmocker.core.TimesVerificationMode;
import io.github.dallenpyrah.contextualmocker.core.AtLeastVerificationMode;
...
class VerificationMethodCaptureHandlerTest {
    ...
    void testInvoke_NoInvocations_DoesNotThrow() throws Throwable {
        ...
        ContextualVerificationMode mode = mock(ContextualVerificationMode.class);
    ...
    void testInvoke_WithMatchingInvocation_TimesVerificationMode() throws Throwable {
        ...
        try (var mockStatic = mockStatic(MockRegistry.class)) {
            ...
            TimesVerificationMode timesMode = mock(TimesVerificationMode.class);
    ...
    void testInvoke_WithNonMatchingInvocation_AtLeastVerificationMode() throws Throwable {
        ...
        try (var mockStatic = mockStatic(MockRegistry.class)) {
            ...
            AtLeastVerificationMode atLeastMode = mock(AtLeastVerificationMode.class);
    ...
    void testVerificationWithArgumentMatchers() throws Throwable {
        ...
        try (var mockStatic = mockStatic(MockRegistry.class);
            ...
            TimesVerificationMode timesMode = new TimesVerificationMode(1);
